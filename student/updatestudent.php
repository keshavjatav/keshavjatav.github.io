...
<div class="sidenav" id="mySidenav">
    ...
    <div class="content" id="main">
        ...
        <div id="head-div"><p>Update Student</p></div>
        <!-- <span></span> -->
    ...
    <div class="main-entry-div">
        ...
        <div class="entry-div">
            <input type="text" name="search" id="scholar-number" placeholder="Scholar Number/name/mobile/">
        ...
        <div class="entry-div">
            ...
            <input type="text" name="email-id" id="email-id" placeholder="Gmail/Email Id (Optional)">
        </div>
        ...
        <div class="entry-div">
            ...
            <select name="bank-account-name" id="bank-account-name" class="bank-name">
